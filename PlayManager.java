...
// this means the current mino immediately collided a block and couldn't move at all
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.drawString("tertrimino next", x + 0, y + -10);
        ...
        if (gameOver) {
            ...
            x = left_x + -350;
            y = top_y + 320;
            g2.drawString("Here we go again?", x, y);
        }
         x = 35;
         y = top_y +550;
         g2.setColor(Color.WHITE);
         g2.setFont(new Font("Courier New",Font.ITALIC,22));
         g2.drawString("Tetris Remake 6404062663266 ",x,y);
    }
}
